...
use Tal7aouy\Pdf2Image\Pdf;
use Tal7aouy\Pdf2Image\Exceptions\InvalidFormat;
use Tal7aouy\Pdf2Image\Exceptions\PdfDoesNotExist;
use Tal7aouy\Pdf2Image\Exceptions\PageDoesNotExist;

beforeEach(function () {
    $this->testFile = __DIR__.'/pdf/test.pdf';
    $this->multipageTestFile = __DIR__.'/pdf/multipage.pdf';
